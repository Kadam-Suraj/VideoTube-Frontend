...
const Footer = () => {
    ...
    return (
        <footer className="absolute bottom-0 left-0 right-0 flex items-center h-16 gap-2 p-3 border-t bg-background/75 shrink-0 justify-evenly sm:hidden backdrop-blur">
            {
